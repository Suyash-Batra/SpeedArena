        ...
        <div class="sidebar">
            <div class="league">
                ...
                if(con != null) {
                    ...
                    while (rsAll.next()) { j++; if (uid == rsAll.getInt(1)) break; }
                }
...
<%
if (request.getParameter("logout") != null) { session.invalidate(); response.sendRedirect("login.jsp"); return; }
if (request.getParameter("delete") != null) {
    PreparedStatement pd = con.prepareStatement("delete from users where user_id = ?");
    PreparedStatement pd1 = con.prepareStatement("delete from scores where user_id = ?");
    pd.setInt(1, uid); pd1.setInt(1, uid); pd1.executeUpdate(); pd.executeUpdate();
    session.invalidate(); response.sendRedirect("login.jsp"); return;
}
%>
</body>
