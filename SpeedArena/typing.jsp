<%@ include file="navbar.jsp"%>
    ...
    <div class="title2">Typing Test</div></div>
    ...
    <div class="card-holder"><div class="card">
            ...
            <div class="card-desc">Words per minuite.</div>
        </div>
    <div class="card">
    ...
    <%
        ...
        PreparedStatement rt = con.prepareStatement("Select * from para order by RAND()");
        ResultSet rpara = rt.executeQuery();
        rpara.next();
        String randtext = rpara.getString(2);
    %>
    </form>
    <script>
        var text = "<%=randtext%>";
